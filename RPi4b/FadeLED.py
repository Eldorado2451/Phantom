...
v1.1 updates: Added a start value of -200 to test the initial fade delay. Created a conditional statement to check if dc is within the range of 0 and 100.
...
dc = -200                           # Create a variable to store the value of teh Duty Cycle; Start val is -200 to test initial fade delay
